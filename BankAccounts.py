...
def getBank():
    url = 'https://www.savethestudent.org/money/student-banking/student-bank-accounts.html'  # Replace with the URL of the page you want to scrape
    ...
    if table:
        ...
        # Step 5: Extract and print data from the rows
        for row in rows:
